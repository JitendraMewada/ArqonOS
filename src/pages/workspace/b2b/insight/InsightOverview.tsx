...
import { BarChart3, TrendingUp, Activity, PieChart, LineChart, ArrowUpRight } from 'lucide-react';
    ...
    <div className="p-6 h-full flex flex-col gap-6 animate-in fade-in duration-300 overflow-y-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-medium text-slate-500">Your central hub for data intelligence and predictive analytics.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-5 shadow-sm">
           <div className="flex items-center gap-3 mb-2">
             ...
             <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Active Reports</p>
           </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-5 shadow-sm">
           <div className="flex items-center gap-3 mb-2">
             ...
             <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Data Streams</p>
           </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1">
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl flex flex-col overflow-hidden shadow-sm">
          <div className="p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50">
             <h3 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
               <TrendingUp className="w-4 h-4 text-indigo-500" /> Performance Trends
             </h3>
          </div>
          <div className="p-5 flex-1 flex flex-col items-center justify-center min-h-[250px]">
             <LineChart className="w-16 h-16 text-slate-200 dark:text-slate-800 mb-4" />
             <p className="text-sm font-semibold text-slate-500">Key Performance Indicators Chart</p>
             <p className="text-xs text-slate-400 mt-1">Data visualization layer initializing...</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl flex flex-col overflow-hidden shadow-sm">
          <div className="p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50 flex items-center justify-between">
             <h3 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
               <Activity className="w-4 h-4 text-orange-500" /> Recent Insights
             </h3>
          ...
          <div className="p-5 flex-1 overflow-y-auto space-y-4">
             <p className="text-xs text-slate-500 italic mb-4">AI-generated data insights and alerts will appear here.</p>
          </div>
        </div>
      </div>
    </div>
